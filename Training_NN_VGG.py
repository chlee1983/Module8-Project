...
writer = SummaryWriter('runs/tensor_board_vgg_19')
training_model = models.vgg19_bn(pretrained=True)
...
def save_checkpoint(model, epoch, optimizer, best_acc):
    ...
    torch.save(state, '20211026_vgg_19.pth.tar')
...
checkpoint = torch.load('20211026_vgg_19.pth.tar')
...
torch.save(training_model.state_dict(), '20211026_vgg_19.pth')
