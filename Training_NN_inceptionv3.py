...
writer = SummaryWriter('runs/tensor_board_inception_v3')
training_model = models.inception_v3(pretrained=True)
...
def save_checkpoint(model, epoch, optimizer, best_acc):
    ...
    torch.save(state, '20211026_inception_v3.pth.tar')
...
checkpoint = torch.load('20211026_inception_v3.pth.tar')
...
torch.save(training_model.state_dict(), '20211026_inception_v3.pth')
