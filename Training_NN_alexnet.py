...
writer = SummaryWriter('runs/tensor_board_alexnet')
...
def save_checkpoint(model, epoch, optimizer, best_acc):
    ...
    torch.save(state, '20211026_alexnet.pth.tar')
...
checkpoint = torch.load('20211026_alexnet.pth.tar')
...
torch.save(training_model.state_dict(), '20211026_alexnet.pth')
